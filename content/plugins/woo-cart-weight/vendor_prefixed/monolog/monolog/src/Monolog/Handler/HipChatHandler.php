 ...
 */
class HipChatHandler extends \WCWeightVendor\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \WCWeightVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    {
        switch (\true) {
            case $level >= \WCWeightVendor\Monolog\Logger::ERROR:
                return 'red';
            case $level >= \WCWeightVendor\Monolog\Logger::WARNING:
                return 'yellow';
            case $level >= \WCWeightVendor\Monolog\Logger::INFO:
                return 'green';
            case $level == \WCWeightVendor\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
