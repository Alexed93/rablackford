...
if (!\interface_exists('WCWeightVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\class_exists('WCWeightVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\class_exists('WCWeightVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \WCWeightVendor\WPDesk_Translatable, \WCWeightVendor\WPDesk_Buildable, \WCWeightVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
