...
window.$ = jquery__WEBPACK_IMPORTED_MODULE_0___default.a; // import modernizr build

__webpack_require__(/*! ./vendor/modernizr.js */ "./assets/app/js/vendor/modernizr.js"); // slick carousel
// const slick = require('slick-carousel');
// partials not reliant on jquery


__webpack_require__(/*! ./partials/debounce.js */ "./assets/app/js/partials/debounce.js");

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  __webpack_require__(/*! ./vendor/custom-select.jquery.js */ "./assets/app/js/vendor/custom-select.jquery.js");

  __webpack_require__(/*! ./partials/responsive-svg.js */ "./assets/app/js/partials/responsive-svg.js");
  /**
  ...
  var toggleNav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.toggle__icon--nav');
  /**
  ...
  */
  ...
  allPanels.hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list__major').click(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass('is-active')) {
      //closing
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.list__sub').slideUp();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('is-active').addClass('sidebar__list--open').removeClass('sidebar__list--close');
    } else {
      //opening
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('sidebar__list--close').addClass('is-active').removeClass('sidebar__list--open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.list__sub').slideDown();
      allPanels.slideUp();
    }
...
/***/ "./assets/app/js/partials/debounce.js":
/*!********************************************!*\
  !*** ./assets/app/js/partials/debounce.js ***!
  \********************************************/
...
/***/ "./assets/app/js/partials/responsive-svg.js":
/*!**************************************************!*\
  !*** ./assets/app/js/partials/responsive-svg.js ***!
  \**************************************************/
...
function responsiveSvgIe() {
  ...
  for (var i = 0; i < svgs.length; i++) {
    ...
    wrapper.style.textAlign = 'left'; //wrapper.style.backgroundColor = 'black';
  }
}
...
/***/ "./assets/app/js/vendor/custom-select.jquery.js":
/*!******************************************************!*\
  !*** ./assets/app/js/vendor/custom-select.jquery.js ***!
  \******************************************************/
/*! no static exports found */
...
jQuery(document).ready(function ($) {
  CustomSelect = function CustomSelect(realSelectBox) {
    //wrap select div around select element
    realSelectBox.wrap("<div class='customselect'></div>"); //element to display selected option

    var fakeSelect = $('<div/>', {
      "class": "select__placeholder"
    }).insertAfter(realSelectBox); //add text to fake select

    fakeSelect.text(realSelectBox.find("option:selected").text()); //style real select box to be same size as fake select
...
/***/ "./assets/app/js/vendor/modernizr.js":
/*!*******************************************!*\
  !*** ./assets/app/js/vendor/modernizr.js ***!
  \*******************************************/
/*! no static exports found */
...
!function (e, t, n) {
  ...
  function g(e, t, n, o, i) {
    ...
    return r(t, "string") || r(t, "undefined") ? h(a, t, o, i) : (a = (e + " " + N.join(s + " ") + s).split(" "), f(a, t, n));
  }
  ...
  E || !function (e, t) {
    ...
    function a(e, n) {
      ...
      for (var o = n.frag.cloneNode(), s = 0, a = r(), l = a.length; l > s; s++) {
        o.createElement(a[s]);
      }
    ...
    function c(e) {
      e || (e = t);
      var r = i(e);
      return !C.shivCSS || f || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || l(e, r), e;
    }
    ...
    e.html5 = C, c(t), "object" == ( false ? undefined : _typeof(module)) && module.exports && (module.exports = C);
  }("undefined" != typeof e ? e : this, t);
  var b = x._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
  x._prefixes = b, Modernizr.addTest("opacity", function () {
    var e = s("a").style;
  ...
  Modernizr._q.unshift(function () {
    delete P.style;
  }), x.testAllProps = g, x.testAllProps = v, Modernizr.addTest("flexbox", v("flexBasis", "1px", !0)), Modernizr.addTest("csstransforms", function () {
    ...
    if (e && (!t || "webkitPerspective" in S.style)) {
      ...
      Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", T(r + n, function (t) {
        e = 7 === t.offsetWidth && 18 === t.offsetHeight;
      });
    }

    return e;
  }), o(), i(y), delete x.addTest, delete x.addAsyncTest;

  for (var F = 0; F < Modernizr._q.length; F++) {
    Modernizr._q[F]();
  }
...
throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\n\n    }\n    ^\n      Invalid CSS after \"    }\": expected selector or at-rule, was \"}\"\n      in /Users/jameschestnutt/sites/rablackford/content/themes/ra/assets/app/scss/interface/_nav.scss (line 191, column 6)\n    at /Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/webpack/lib/NormalModule.js:316:20\n    at /Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/loader-runner/lib/LoaderRunner.js:367:11\n    at /Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/loader-runner/lib/LoaderRunner.js:233:18\n    at context.callback (/Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/loader-runner/lib/LoaderRunner.js:111:13)\n    at Object.callback (/Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/sass-loader/dist/index.js:89:7)\n    at Object.done [as callback] (/Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/neo-async/async.js:8069:18)\n    at options.error (/Users/jameschestnutt/sites/rablackford/content/themes/ra/node_modules/node-sass/lib/index.js:294:32)");
...
/***/ 0:
/*!************************************************************************************!*\
  !*** multi @babel/polyfill ./assets/app/js/index.js ./assets/app/scss/styles.scss ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
__webpack_require__(/*! ./assets/app/js/index.js */"./assets/app/js/index.js");
module.exports = __webpack_require__(/*! ./assets/app/scss/styles.scss */"./assets/app/scss/styles.scss");
...
/******/ });
//# sourceMappingURL=main.dev.01b9ffe1f9547930c49a.js.map